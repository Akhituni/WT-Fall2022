...
<body>
    ...
    <td>
        <input type="text" name="name" required placeholder="Tuni"><br>
    </td>
    </tr>
    <tr>
        <td>NID number: </td>   
    ...
    <td>
        <input type="text" name="address1" required placeholder="Road/area"><br>
        <input type="text" name="address2" required placeholder="City"><br>
